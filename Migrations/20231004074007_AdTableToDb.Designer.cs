...
namespace Lab4.Migrations
{
    ...
    [Migration("20231004074007_AdTableToDb")]
    partial class AdTableToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lab4.NewFolder.Course", b =>
                {
            ...
            modelBuilder.Entity("Lab4.NewFolder.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("Lab4.NewFolder.Learner", b =>
                {
                    b.Property<int>("LearnerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lab4.NewFolder.Major", b =>
                {
                    b.Property<int>("MajorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lab4.NewFolder.Enrollment", b =>
                {
                    b.HasOne("Lab4.NewFolder.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lab4.NewFolder.Learner", "Learner")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("Lab4.NewFolder.Learner", b =>
                {
                    b.HasOne("Lab4.NewFolder.Major", "Major")
                        .WithMany("Learners")
